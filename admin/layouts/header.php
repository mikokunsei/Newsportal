...
<head>
  ...
  ?>
  <title>Admin <?= $data_web['title'] ?></title>
  ...
  <!-- Icon Logo -->
  <link rel="icon" href="public/image/icon/<?= $data_web['icon'] ?>" type="image/png">

  <!-- Tag Input -->
  <link rel="stylesheet" href="https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  <link rel="stylesheet" href="public/assets/src/jquery.tagsinput-revisited.css">
