...
if ($icon_name != "" && $logo_name != "") {
    ...
    $query_update = mysqli_query($conn, "UPDATE web_settings SET title = '$title', logo = '$logo_name', icon = '$icon_name', alamat = '$alamat', email = '$email', no_telp = '$telp', tahun = '$tahun', copyright = '$copyright', size_file = '$size_file', ekstensi = '$ekstensi' ");
    ...
    $query_update = mysqli_query($conn, "UPDATE web_settings SET title = '$title', logo = '$logo_name', alamat = '$alamat', email = '$email', no_telp = '$telp', tahun = '$tahun', copyright = '$copyright', size_file = '$size_file', ekstensi = '$ekstensi' ");
    ...
    $query_update = mysqli_query($conn, "UPDATE web_settings SET title = '$title', icon = '$icon_name', alamat = '$alamat', email = '$email', no_telp = '$telp', tahun = '$tahun', copyright = '$copyright', size_file = '$size_file', ekstensi = '$ekstensi' ");
    ...
    $query_update = mysqli_query($conn, "UPDATE web_settings SET title = '$title', alamat = '$alamat', email = '$email', no_telp = '$telp', tahun = '$tahun', copyright = '$copyright', size_file = '$size_file', ekstensi = '$ekstensi' ");
