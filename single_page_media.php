...
?>
    ...
    <head>
        ...
        ?>
        <title><?= $data_web['title'] ?> By Media <?= $media_news ?></title>
        <meta charset="utf-8">
                        ...
                        <div class="left_content">
                            <div class="single_page">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><a href="single_page_media.php?media=<?= $media_news ?>"><?= ucfirst($media_news); ?></a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="single_post_content">
                                    ...
                                    ?>
                                        <ul class="pagination">
                                            ...
                                            if ($halaman - 2 > 0) {
                                                ?>
                                                <li class="page-item"><a href="single_page_media.php?media=<?= $media_news ?>&halaman=<?= $halaman - 2 ?>"><?= $halaman - 2 ?></a></li>
                                            <?php
                                            }

                                            if ($halaman - 1 > 0) {
                                            ?>
                                                <li class="page-item"><a href="single_page_media.php?media=<?= $media_news ?>&halaman=<?= $halaman - 1 ?>"><?= $halaman - 1 ?></a></li>
                                            <?php
                                            }
                                            ?>
                                            ...
                                            if ($halaman < $jml_halaman - 2) {
                                                ...
                                                ?>
                                                <li class="page-item"><a href="single_page_media.php?media=<?= $media_news ?>&halaman=<?= $jml_halaman ?>"><?= $jml_halaman ?></a></li>
                                            <?php
                                            }
